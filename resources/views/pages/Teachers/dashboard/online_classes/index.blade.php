            ...
            <div class="card card-statistics h-100">
                ...
                @endif
                    <div class="col-xl-12 mb-30">
                        <div class="card card-statistics h-100">
                            <div class="card-body">
                                <a href="{{route('teacher.dashboard.online_zoom_classes.create')}}" class="btn btn-success" role="button"
                                 aria-pressed="true">{{ trans('online_classes.add_new_online_lesson') }}    </a>
