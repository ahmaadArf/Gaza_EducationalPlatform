                                    ...
                                    <table id="datatable" class="table  table-hover table-sm table-bordered p-0"
                                        ...
                                        @foreach($subjects as $subject)
                                            ...
                                            <td>{{$subject->classroom->name}}</td>
                                                <td>
                                                    <a href="{{route('student.dashboard.subjects.show',$subject->id)}}" class="btn btn-info btn-sm"
                                                         role="button" aria-pressed="true"><i class="fas fa-eye "></i> {{ __('subject.course_content') }}</a>
                                                </td>
                                            </tr>
