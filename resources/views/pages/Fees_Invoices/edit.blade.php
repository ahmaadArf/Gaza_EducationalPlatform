...
@section('title')
    {{ __('fees_Invoices.edit_educational_fee') }}
@stop
@endsection
@section('page-header')
    <!-- breadcrumb -->
                    ...
                    <form action="{{route('dashboard.fees_Invoices.update',$fee_invoices->id)}}" method="post" autocomplete="off">
                        ...
                        <div class="form-row">
                            <div class="form-group col">
                                <label for="inputEmail4">{{ __('fees_Invoices.student_name') }} </label>
                            ...
                            <div class="form-group col">
                                <label for="inputEmail4">{{ __('fees_Invoices.amount') }}</label>
                        ...
                        <div class="form-row">
                            ...
                            <div class="form-group col">
                                <label for="inputZip">{{ __('fees_Invoices.fee_type') }} </label>
                        ...
                        <div class="form-group">
                            <label for="inputAddress">{{ __('fees_Invoices.description') }}</label>
