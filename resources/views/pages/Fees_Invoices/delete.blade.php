    ...
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <h5 style="font-family: 'Cairo', sans-serif;" class="modal-title" id="exampleModalLabel">{{ __('fees_Invoices.delete_invoice') }} </h5>
            ...
            <div class="modal-body">
                <form action="{{route('dashboard.fees_Invoices.destroy',$Fee_invoice->id)}}" method="post">
                    ...
                    <h5 style="font-family: 'Cairo', sans-serif;"> {{ __('fees_Invoices.delete_confirmation') }}</h5>
