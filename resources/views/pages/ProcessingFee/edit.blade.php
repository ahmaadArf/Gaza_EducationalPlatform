...
@section('title')
  {{ __('processing.edit_fee_processing') }}
@stop
@endsection
@section('page-header')
    <!-- breadcrumb -->
@section('PageTitle')
    {{ __('processing.edit_fee_processing') }}   : <label style="color: red">{{$ProcessingFee->student->name}}</label>
@stop
<!-- breadcrumb -->
@endsection
@section('content')
                ...
                <div class="card-body">
                    ...
                    @endif
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    <div class="form-group">
                                        <label>{{ __('processing.amount') }} : <span class="text-danger">*</span></label>
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    <div class="form-group">
                                        <label>{{ __('processing.description') }} : <span class="text-danger">*</span></label>
