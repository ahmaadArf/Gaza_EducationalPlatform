...
@section('title')
    {{ __('question.edit_question') }}
@stop
@endsection
@section('page-header')
    <!-- breadcrumb -->
@section('PageTitle')
    {{ __('question.edit_question') }} :<span class="text-danger">{{$question->title}}</span>
@stop
<!-- breadcrumb -->
@endsection
@section('content')
                        ...
                        <div class="col-md-12">
                            ...
                            <form action="{{ route('dashboard.questions.update','test') }}" method="post" autocomplete="off">
                                ...
                                <div class="form-row">
                                    ...
                                    <div class="col">
                                        <label for="title">{{ __('question.question') }} </label>
                                ...
                                <div class="form-row">
                                    <div class="col">
                                        <label for="title">{{ __('question.answers') }}</label>
                                ...
                                <div class="form-row">
                                    <div class="col">
                                        <label for="title">{{ __('question.correct_answer') }} </label>
                                ...
                                <div class="form-row">
                                    <div class="col-6">
                                        <div class="form-group">
                                            <label for="Grade_id">{{ __('question.test_name') }}  : <span
                                    ...
                                    <div class="col-6">
                                        <div class="form-group">
                                            <label for="Grade_id">{{ __('question.score') }} : <span class="text-danger">*</span></label>
