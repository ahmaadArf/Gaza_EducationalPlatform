...
@section('css')
@section('title')
{{trans('books.edit_book')}} {{$book->title}}
@stop
@endsection
@section('page-header')
    <!-- breadcrumb -->
                        ...
                        <div class="col-md-12">
                            ...
                            <form action="{{route('dashboard.library.update','test')}}" method="post" enctype="multipart/form-data">
                                ...
                                <div class="form-row">
                                    ...
                                    <div class="col">
                                        <label for="title">{{ trans('books.book_name') }} </label>
                                ...
                                <div class="form-row">
                                    <div class="col">
                                        <div class="form-group">
                                            <label for="Grade_id">{{trans('books.education_stage')}} : <span class="text-danger">*</span></label>
                                    ...
                                    <div class="col">
                                        <div class="form-group">
                                            <label for="Classroom_id">{{trans('books.grade_level')}} : <span class="text-danger">*</span></label>
                                    ...
                                    <div class="col">
                                        <div class="form-group">
                                            <label for="section_id">{{trans('books.section')}} : </label>
                                ...
                                <div class="form-row">
                                    <div class="col">
                                        ...
                                        <div class="form-group">
                                            <label for="academic_year">{{ trans('books.attachments') }} : <span class="text-danger">*</span></label>
